    ...
    return Scaffold(
      appBar:  AppBar(toolbarHeight: 60,
        ...
        title: Padding(
          ...
          child: Text('Product details',style: TextStyle(fontFamily:'cantata' ,fontSize: 20,color: Colors.white)),
        ),
      ...
      body: SingleChildScrollView(
        child: Consumer<mainProvider>(
          builder: (context,value,child) {
            return Column(
              children: [
                ...
                Center(
                  child: InkWell(onTap: (){
                    ...
                    Container(
                      ...
                      child:Image.file(value.filebookimage!,fit: BoxFit.fill,)
                    ...
                    Container(
                        ...
                        child:Image.network(value.imageUpdate!,fit: BoxFit.fill,)
                    ):
                    ...
                    Container(
                      ...
                      child: Icon(Icons.add_a_photo_outlined,color: Colors.black54,size: 70),
                    )
                ...
                Padding(
                  ...
                  child: Text('Book name:',style: TextStyle(color: Colors.black,fontFamily: 'cantata',fontSize: 16),),
                ),
                ...
                Padding(
                  ...
                  child: Text('Author:',style: TextStyle(color: Colors.black,fontFamily: 'cantata',fontSize: 16),),
                ),
                SizedBox(width: MediaQuery.of(context).size.width/1.1,
                  child: TextField(
            ...
            return value.categorynameslist.where((categoryadd item) => item.categoryname.toLowerCase()
            ...
            child: Container(
            child: SizedBox(width: MediaQuery.of(context).size.width/1.1,
              child: TextFormField(
            ...
            color: Colors.black,
                ...
                Padding(
                  padding: const EdgeInsets.only(right:210),
                  child: Text('Description:',style: TextStyle(color: Colors.black,fontFamily: 'cantata',fontSize: 16),),
                ),
                SizedBox(width: MediaQuery.of(context).size.width/1.1,
                  child: TextField(
                ...
                Padding(
                  ...
                  child: Text('Price:',style: TextStyle(color: Colors.black,fontFamily: 'cantata',fontSize: 16),),
                ),
                Padding(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child:frmId=="New"?
            Center(child: Text('Add',style: TextStyle(fontFamily: 'cantata',fontSize: 22,color: Colors.white,fontWeight: FontWeight.bold))):
                    Center(child: Text('Update',style: TextStyle(fontFamily: 'cantata',fontSize: 22,color: Colors.white,fontWeight: FontWeight.bold)))
