      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text('Book : RAM C/O ANANDHI',style: TextStyle(color: Colors.white,fontSize: 12,fontFamily: 'cantata',),),
          ),
          SizedBox(height: 5,),
          Padding(
            padding: const EdgeInsets.only(right: 150),
            child: Text('Author : Akhil P Dharmajan',style: TextStyle(color: Colors.white,fontSize: 12,fontFamily: 'cantata',),),
          ),
          SizedBox(height: 5,),
          Padding(
            padding: const EdgeInsets.only(right: 220),
            child: Text('Category : Novel',style: TextStyle(color: Colors.white,fontSize: 12,fontFamily: 'cantata',),),
          ),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text('335.00',style: TextStyle(fontFamily: 'cantata',fontSize: 22,color: Colors.black),),
                    ...
                    ElevatedButton(
                        ...
                        child: Text("Buy Now",style: TextStyle(fontSize: 14,color: Colors.white,fontFamily: 'cantata'),)),
                  ],
                ),
