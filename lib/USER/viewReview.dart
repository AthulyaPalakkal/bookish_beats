      ...
      child: Scaffold(
        ...
        body:Column(
          children: [
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 10,),
                  Text('Posted by Athulya',style: TextStyle(color:clWhite,fontFamily: 'cantata',fontSize: 12),),
                  SizedBox(width: 130,),
            ...
            const Center(child: Image(image: AssetImage('assets/book3.jpg'),height: 170)),
            const SizedBox(
              height: 10,
            ),
            ...
            Expanded(
              ...
              child: Align(
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(color: clWhite,
                  ...
                  child: const Column(
                    children: [
                      Padding(
                        ...
                        child: Text('The Kite Runner',style: TextStyle(color: clBlack,
                            fontFamily: 'cantata',
