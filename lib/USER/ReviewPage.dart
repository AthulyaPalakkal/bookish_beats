...
//             child: Icon(Icons.arrow_back,color: Colors.white)),
        title: Center(child: Text('Reviews',style: TextStyle(fontFamily:'gravitas' ,fontSize: 20,color: Colors.white))),
                        ...
                        child: Container( width: MediaQuery.of(context).size.width/1.1,
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  Image(image: NetworkImage(value.reviewlist[index].reviewimage),height: 110,width: 100,),
                                  Padding(
                                    padding: const EdgeInsets.all(10),
                                    child: SizedBox(width: width/1.9,
                                        child: Text(value.reviewlist[index].review,maxLines: 5,
                                          overflow: TextOverflow.ellipsis,style: TextStyle(color: Colors.black,fontSize: 10,fontFamily: 'cantata'),)),
                                  ),
                                ],
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      Text('View More',style: TextStyle(color: Colors.blue,fontSize: 14,fontFamily: 'cantata',),),
                                      Icon(Icons.arrow_circle_right_rounded,color: Colors.blue,size: 30,)
                                    ],
                                  ),
                                ),
                              )
